    ...
    return (
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6 col-md-8 col-12" ref={trou}>
                    <div className="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                        ...
                        <h2 className="text-white ms-4 mb-0">Contactez moi</h2>
                    </div>
                </div>

                <div className="clearfix"></div>

                <div className="col-lg-6 col-md-6 col-12 pe-lg-0" ref={Charisme}>
                    <div className="contact-info contact-info-border-start d-flex flex-column">
                        ...
                        <ul className="footer-menu">
                            <li className="footer-menu-item"><a href="#" className="footer-menu-link">site web</a></li>

                            <li className="footer-menu-item"><a href="#" className="footer-menu-link">Application web</a></li>
                        ...
                        <strong className="site-footer-title d-block mt-4 mb-3">Mes Reseaux sociaux</strong>

                        <ul className="social-icon">
                            <li className="social-icon-item"><a href="https://linkedin.com/in/habacuc-mayombo-bb52b4216?utm_content=profile&utm_medium=android_app" className="social-icon-link bi-linkedin"></a></li>

                            <li className="social-icon-item"><a href="https://facebook.com/profil.php?id=100089237450626" className="social-icon-link bi-facebook"></a></li>

                            <li className="social-icon-item"><a href="https://github.com/Letelepathe" className="social-icon-link bi-github"></a></li>

                            <li className="social-icon-item"><a href="https://wa.me/+243996834353" className="social-icon-link bi-whatsapp"></a></li>
                        </ul>

                        <strong className="site-footer-title d-block mt-4 mb-3">Commençons ce projet</strong>

                        <p className="mb-0">Disponible pour ce projet fascinant</p>
                    </div>
                </div>

                <div className="col-lg-6 col-md-6 col-12 ps-lg-0" ref={CQH}>
                    <div className="contact-info d-flex flex-column">
                        <strong className="site-footer-title d-block mb-3">Apropos</strong>
                        ...
                        <strong className="site-footer-title d-block mt-4 mb-3">Appelez moi</strong>
                ...
                {/* <div className="col-lg-6 col-12 mt-5 mt-lg-0" ref={trou}>
                    <form action="#" method="get" className="custom-form contact-form" role="form">
                        <div className="row">
                            ...
                            <div className="col-lg-3 col-md-6 col-6">
                                <div className="form-check form-check-inline">
                                    ...
                                    <label className="form-check-label" for="inlineCheckbox1">
                                        ...
                                        <span className="form-check-label-text">site web</span>
                                    </label>
                              </div>
                            </div>
                            ...
                            <div className="col-lg-3 col-md-6 col-6">
                                <div className="form-check form-check-inline">
                                    ...
                                    <label className="form-check-label" for="inlineCheckbox2">
                                        <i className="bi-bag form-check-icon"></i>
                            ...
                            <div className="col-lg-3 col-md-6 col-6">
                                <div className="form-check form-check-inline">
                                    ...
                                    <label className="form-check-label" for="inlineCheckbox3">
                                        ...
                                        <span className="form-check-label-text">application mobile</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-3 col-12 ms-auto">
                                <button type="submit" className="form-control">Envoyez</button>
                            </div>
